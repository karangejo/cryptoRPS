...
/* harmony import */ var _ethereum_RPSfactory__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../ethereum/RPSfactory */ "./ethereum/RPSfactory.js");
...
/*#__PURE__*/
function (_Component) {
  Object(_babel_runtime_corejs2_helpers_esm_inherits__WEBPACK_IMPORTED_MODULE_7__["default"])(NewGame, _Component);
  ...
  function NewGame() {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_classCallCheck__WEBPACK_IMPORTED_MODULE_2__["default"])(this, NewGame);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    _this = Object(_babel_runtime_corejs2_helpers_esm_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_4__["default"])(this, (_getPrototypeOf2 = Object(_babel_runtime_corejs2_helpers_esm_getPrototypeOf__WEBPACK_IMPORTED_MODULE_5__["default"])(NewGame)).call.apply(_getPrototypeOf2, [this].concat(args)));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                _context.next = 9;
                return _ethereum_RPSfactory__WEBPACK_IMPORTED_MODULE_13__["default"].methods.createRPSGame(_this.state.amount, _this.state.hash).send({
                  from: accounts[0]
                });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(NewGame, [{
    key: "render",
    value: function render() {
      var _this2 = this;

      return react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Segment"], {
        raised: true,
        color: "green"
      }, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("h3", null, "Create A New Game!"), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Form"], {
        onSubmit: this.onSubmit,
        error: !!this.state.errorMessage
      }, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Form"].Field, null, react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement("label", null, "Enter the Amount of your Bet in Wei"), react__WEBPACK_IMPORTED_MODULE_9___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_11__["Input"], {
        label: "wei",
        labelPosition: "right",
...
/* harmony import */ var _abi_RPSfactory_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./abi/RPSfactory.json */ "./ethereum/abi/RPSfactory.json");
var _abi_RPSfactory_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./abi/RPSfactory.json */ "./ethereum/abi/RPSfactory.json", 1);

 // this is the address of the latest deployment of the contract
//change this to connect to a different deployment

var address = '0x07c47e1aa87c20a9fa67fe9ee83acf4403741676';
var instance = new _web3__WEBPACK_IMPORTED_MODULE_0__["default"].eth.Contract(_abi_RPSfactory_json__WEBPACK_IMPORTED_MODULE_1__, address);
/* harmony default export */ __webpack_exports__["default"] = (instance);

/***/ }),

/***/ "./ethereum/abi/RPSfactory.json":
/*!**************************************!*\
  !*** ./ethereum/abi/RPSfactory.json ***!
  \**************************************/
...
module.exports = [{"constant":false,"inputs":[{"name":"amount","type":"uint256"},{"name":"choiceHash","type":"bytes32"}],"name":"createRPSGame","outputs":[],"payable":false,"stateMutability":"nonpayable","type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"amounts","outputs":[{"name":"","type":"uint256"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[{"name":"","type":"uint256"}],"name":"deployedPRPS","outputs":[{"name":"","type":"address"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"getDeployedAddress","outputs":[{"name":"","type":"address[]"}],"payable":false,"stateMutability":"view","type":"function"},{"constant":true,"inputs":[],"name":"getDeployedAmounts","outputs":[{"name":"","type":"uint256[]"}],"payable":false,"stateMutability":"view","type":"function"}];
...
/* harmony import */ var _ethereum_RPSfactory__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../ethereum/RPSfactory */ "./ethereum/RPSfactory.js");
...
/* harmony import */ var _components_newGame__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../components/newGame */ "./components/newGame.js");
...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(Index, [{
    ...
    value: function renderGames() {
      ...
      var items = this.props.addresses.map(function (address, index) {
        return {
          header: "Bet Amount: ".concat(_this.props.amounts[index]),
          ...
          }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("a", null, "View Game")),
          meta: "Address: ".concat(address),
          fluid: true,
          color: "green",
          raised: true
        };
    ...
    key: "render",
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_layout__WEBPACK_IMPORTED_MODULE_8__["default"], null, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(semantic_ui_react__WEBPACK_IMPORTED_MODULE_9__["Segment"], {
        raised: true,
        color: "orange"
      }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement("h1", null, "List of Games"), this.renderGames()), react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_components_newGame__WEBPACK_IMPORTED_MODULE_12__["default"], null));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
      ...
      _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        var addresses, amounts;
        return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return _ethereum_RPSfactory__WEBPACK_IMPORTED_MODULE_10__["default"].methods.getDeployedAddress().call();

              case 2:
                addresses = _context.sent;
                _context.next = 5;
                return _ethereum_RPSfactory__WEBPACK_IMPORTED_MODULE_10__["default"].methods.getDeployedAmounts().call();

              case 5:
                amounts = _context.sent;
...
module.exports = __webpack_require__(/*! /home/karang/Documents/Ethereum/cryptoRPS/pages/index.js */"./pages/index.js");
